...
// Clerk's <SignIn> renders whatever methods are enabled in the Clerk dashboard
// (we use Google sign-in). Only mounted under <ClerkProvider>, so the import is
// safe elsewhere.
  ...
  return (
    <div className="scroll-slim flex h-full flex-col items-center overflow-y-auto px-6 py-8">
      ...
      <p className="mt-2 max-w-xs text-center text-[15px] leading-relaxed text-ink/60">
        Your buddy adapts to your Hindi level. Sign in with Google so your progress is saved to your
